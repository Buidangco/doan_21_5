            ...
            <div class="shop-section mb-80">
                <div class="container">
                    <div class="row">
                        ...
                        <input id="Auth" type="" style="opacity: 0" name="" value="{{Auth::guard('admin')->user()->id}}">
                        @endif
                        ...
                        <div class="col-md-3 col-xs-12">
                            ...
                            <aside class="widget widget-categories box-shadow mb-30">
                                ...
                                <div id="cat-treeview" class="product-cat">
                                    <ul class="treeview">
                                        <li class="closed expandable"><div class="hitarea closed-hitarea expandable-hitarea"></div><a href="#">Thể loại</a>
